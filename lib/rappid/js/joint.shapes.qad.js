...
joint.shapes.qad.Question = joint.shapes.basic.Generic.extend(_.extend({}, joint.shapes.basic.PortsModelInterface, {
    ...
    defaults: joint.util.deepSupplement({
        ...
        attrs: {
            ...
            '.option-text': { 'font-size': 11, y: '1.2em', fill: '#4b4a67', 'y-alignment': .4, 'x-alignment': 20 },
            '.question-text': { 'font-size': 15, fill: 'white', 'ref-x': .5, 'ref-y': 10, 'x-alignment': 'middle', ref: '.body', style: { 'text-shadow': '1px 1px 0px gray' } },
