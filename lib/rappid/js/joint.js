...
joint.dia.ElementView = joint.dia.CellView.extend({
    ...
    renderTools: function() { // Me
        let linkTools = this.vel.findOne(".link-tools");
        if (!linkTools) return this;
        var $tools = $(linkTools.node).empty();
...
// Me
joint.shapes.uml.Note = joint.shapes.basic.Generic.extend({
    markup: '<g class="rotatable"><g class="scalable"><rect/></g><text contenteditable="true" /></g><g class="link-tools"/>',
    toolMarkup: [
        '<g class="link-tool">',
        '<g class="tool-remove" event="remove">',
        '<circle r="11" />',
    ...
    initialize: function() {
        ...
        this.attr('text/text', this.get('note'));

        this.on('change:note', function() {
...
joint.shapes.uml.NoteView = joint.dia.ElementView.extend({
    initialize: function() {
        joint.dia.ElementView.prototype.initialize.apply(this, arguments);
        this.autoresize();
        this.listenTo(this.model, 'change:note', this.autoresize, this);
    },
    autoresize: function() {
        var dim = joint.util.measureText(this.model.get('note'), {
